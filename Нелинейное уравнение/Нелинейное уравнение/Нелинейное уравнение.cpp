...
int main() {
	...
	std::cout << "Приближенное решение методом половинного деления: " << x_bisection << std::endl; // Выводим результат для метода половинного деления
	std::cout << "Приближенное решение методом касательных: " << x_tangent << std::endl; // Выводим результат для метода касательных
	return 0;
}